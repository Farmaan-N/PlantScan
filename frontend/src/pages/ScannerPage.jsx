...
function ScannerPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12">
      {/* Header */}
      <SectionHeader 
        badge="Neural Vision Hub"
        title={<>Identify <span className="text-gradient">Species</span></>}
        subtitle="Initialize our AI core to identify botanical specimens via optical analysis."
      />
        ...
        {isLoading ? (
          ...
          >
            <GlassCard className="p-8 sm:p-16 text-center max-w-xl mx-auto overflow-hidden !bg-slate-950/60 shadow-2xl relative">
               ...
               <Loader message="Synchronizing with neural botanical database..." />
               <div className="mt-8 sm:mt-12 grid grid-cols-1 gap-4 text-left max-w-xs mx-auto">
                  {['Calibrating optical sensors...', 'Extracting leaf morphology...', 'Mapping taxonomic markers...'].map((step, i) => (
                    <motion.div 
                      key={step}
                ...
                >
                  <div className="p-4 sm:p-5 bg-red-500/5 border border-red-500/10 rounded-2xl sm:rounded-[2rem] flex items-center gap-4 text-red-400">
                    ...
                    <div className="flex-1">
                       <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-red-500/60 mb-0.5">Analysis Interference</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                >
                  <div className="p-10 sm:p-12 flex flex-col items-center text-center space-y-6 sm:space-y-8 relative">
                    ...
                    <div className="space-y-3 relative z-10">
                      <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-lime-400">Capture Protocol 01</p>
                      <h3 className="text-3xl sm:text-4xl font-black tracking-tighter uppercase text-white leading-none">
                        Optical <br /> <span className="text-lime-500">Lens</span>
                      </h3>
                      <p className="text-slate-500 text-[10px] font-medium uppercase tracking-widest pt-3 sm:pt-4">Identify via Live Camera</p>
                    </div>
                  </div>
                </GlassCard>
                ...
                >
                  <div className="p-10 sm:p-12 flex flex-col items-center text-center space-y-6 sm:space-y-8 relative">
                    ...
                    <div className="space-y-3 relative z-10">
                      <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-emerald-400">Import Protocol 02</p>
                      <h3 className="text-3xl sm:text-4xl font-black tracking-tighter uppercase text-white leading-none">
                        Digital <br /> <span className="text-emerald-500">Vault</span>
                      </h3>
                      <p className="text-slate-500 text-[10px] font-medium uppercase tracking-widest pt-3 sm:pt-4">Process Local Image Files</p>
                    </div>
                  </div>
                </GlassCard>
              </div>
              ...
              <div className="max-w-4xl mx-auto animate-fade-in space-y-6 sm:space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4">
                   <button onClick={() => setMode(null)} className="flex items-center gap-3 text-slate-500 hover:text-white text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] transition-all group">
                     <ChevronLeft size={16} className="group-hover:-translate-x-1 transition-transform" /> TERMINATE SESSION
                   </button>
              ...
              <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8 animate-fade-in">
                <div className="flex items-center justify-between px-4">
                   <button onClick={() => setMode(null)} className="flex items-center gap-3 text-slate-500 hover:text-white text-[10px] font-black uppercase tracking-[0.3em] transition-all group">
                     <ChevronLeft size={16} className="group-hover:-translate-x-1 transition-transform" /> CANCEL IMPORT
                   </button>
                </div>
                 ...
                 <GlassCard className="p-8 sm:p-12 max-w-2xl mx-auto rounded-[2.5rem] sm:rounded-[3.5rem] relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between mb-8 sm:mb-12">
                       <div className="space-y-1">
                          <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-lime-400">File Ready</p>
                          <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tighter">Identity Target</h3>
                       </div>
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 pt-6 sm:pt-12">
               <div className="md:col-span-2 space-y-6">
                  <div className="flex items-center gap-4">
                     ...
                     <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] sm:tracking-[0.4em] text-slate-600">Calibration Protocol</p>
                     <div className="h-[1px] flex-1 bg-white/5" />
                  </div>
               ...
               <div className="flex flex-col justify-end p-4 border-t sm:border-t-0 sm:border-l border-white/5 sm:pl-8 text-center sm:text-left">
                  <p className="text-slate-700 font-bold uppercase tracking-[0.3em] text-[8px] leading-[2]">
                    Terminal: v1.0.0-PRO <br className="hidden sm:block" />
                    Enc: TLS_AES_256 <br className="hidden sm:block" />
                    Auth: PASSED <br className="hidden sm:block" />
                    Location: Verified
                  </p>
               </div>
            </div>
