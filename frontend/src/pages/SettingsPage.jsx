  ...
  return (
    <div className="space-y-12 max-w-7xl mx-auto">
      ...
      <SectionHeader 
        ...
        subtitle="Manage your cryptographic credentials and botanical cloud profile parameters."
      />
           ...
           <GlassCard className="p-8 border-white/5 h-full relative overflow-hidden group">
              ...
              <div className="space-y-4">
                 {[
                   ...
                   { label: 'Encryption', value: 'AES-256', icon: ShieldCheck, color: 'text-emerald-400' }
                 ].map((spec, i) => (
               ...
               <div className="mt-10 pt-8 border-t border-white/5 space-y-4">
                  <div className="flex items-center gap-2 px-3 py-2 bg-lime-500/5 rounded-lg border border-lime-500/10 mb-2">
                     ...
                     <span className="text-[9px] font-black text-lime-400 uppercase tracking-widest">Botanist Tier Active</span>
                  </div>
            ...
            <GlassCard className="hidden sm:block p-6 border-white/5 bg-white/[0.01]">
               ...
               >
                  <div className="text-left">
                     <p className="text-xs font-black text-white uppercase tracking-tight">Sign Out</p>
                     <p className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">Safely terminate archive link</p>
                  </div>
        ...
        <div className="lg:col-span-8 space-y-8">
           ...
           <div className="space-y-4">
              <div className="flex items-center gap-3 px-1">
                 ...
                 <h3 className="text-xs font-black uppercase tracking-[0.2em] text-white">Profile Information</h3>
              </div>
              <GlassCard className="p-8 border-white/5">
                <form onSubmit={handleUpdateProfile} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Username Alias</label>
                      <input 
                        type="text"
                        value={username}
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Linked Email</label>
                      <div className="w-full bg-white/5 border border-white/5 rounded-xl px-4 py-3 text-slate-500 line-through cursor-not-allowed text-sm">
                        {user?.email}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" disabled={isUpdatingProfile} className="px-10">
                      {isUpdatingProfile ? 'PROCESING...' : 'COMMIT PROFILE UPDATES'}
                    </Button>
                  </div>
                </form>
              </GlassCard>
           ...
           <div className="space-y-4">
              <div className="flex items-center gap-3 px-1">
                 ...
                 <h3 className="text-xs font-black uppercase tracking-[0.2em] text-white">Cryptographic Security</h3>
              </div>
              <GlassCard className="p-8 border-white/5">
                <form onSubmit={handleUpdatePassword} className="space-y-8">
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Verify Passcode</label>
                        <input 
                          type="password"
                  ...
                  <div className="flex justify-end">
                    <Button type="submit" variant="secondary" disabled={isUpdatingPassword} className="px-10">
                      {isUpdatingPassword ? 'ROTATING KEY...' : 'UPDATE ARCHIVE PASSCODE'}
                    </Button>
                  </div>
                </form>
              </GlassCard>
           ...
           <div className="space-y-4">
              <div className="flex items-center gap-3 px-1">
                 ...
                 <h3 className="text-xs font-black uppercase tracking-[0.2em] text-red-500">Atomic Action Zone</h3>
              </div>
              <GlassCard className="p-8 border-red-500/10 bg-red-500/[0.03]">
                 <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="space-y-2">
                       <h4 className="text-lg font-black text-white uppercase tracking-tight">System Decommission</h4>
                       <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest">Wipe all botanical records and terminate local vault access.</p>
                    </div>
